# <div style="display: flex; align-items: center;"><img src="./public/icon-green.png" height="50px" style="margin-right: 1rem; padding-bottom: 5px;" />Nuxt 3 Starter (w/ ESLint & Prettier)</div>
